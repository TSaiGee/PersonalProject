...
public class ColorPickerView extends View {
    ...
    private boolean isRing = false;//是否是圆环
    private int mRingCircle;//圆环半径
    private int mRudeStrokeWidth = 5;
    private Bitmap mBitmapBack; // 背景图片
    private Paint mPaint; // 背景画笔
    private Paint mBlankPaint; // 背景画笔
    ...
    private void init(AttributeSet attrs) {
        ...
        try {
            ...
            mRingCircle = types.getDimensionPixelOffset(
                    R.styleable.color_picker_ring_radius, 30);
        } finally {
